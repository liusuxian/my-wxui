 ...
 * @Date: 2025-05-09 14:05:34
 * @LastEditors: liusuxian 382185882@qq.com
 * @LastEditTime: 2025-05-09 14:18:33
 * @Description:
 *
...
Component({
  ...
  properties: {
    ...
    // 加载框背景色，type=column时生效
    backgroundColor: {
      type: String,
      value: "rgba(0, 0, 0, 0.6)",
    },
    // loading图标地址或base64，type=column时生效
    src: {
      type: String,
      value:
    ...
    // loading图标地址或base64，type=row时生效
    rowsrc: {
      type: String,
      value:
